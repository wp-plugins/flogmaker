<?php
  ...
  function flog_maker_admin_installer(){
	...
	$wpdb->query("INSERT INTO {$table_prefix}flashblog_onglets (nom,fichier,actif,nom_url,picto) VALUES ('Liens','liens.swf',1,'liens','liens.swf')");
	$wpdb->query("INSERT INTO {$table_prefix}flashblog_onglets (nom,fichier,actif,nom_url,picto) VALUES ('Rechercher','recherche.swf',1,'recherche','recherche.swf') ");
